                  ...
                  <td colSpan={2} className="px-6 py-16 text-center">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-gray-500 text-sm">
                        Data ringkasan cabang belum tersedia.
                      </p>
                    </div>
                  </td>
                </tr>
                    ...
                    <div className="flex flex-col items-center">
                      <div className="p-4 bg-gray-100 rounded-full mb-4">
                        <svg
                          ...
                          viewBox="0 0 24 24"
                        >
                          <path d="M12 2a9 9 0 00-9 9v5H2v2h20v-2h-1v-5a9 9 0 00-9-9zM7 21h10v1H7v-1z" />
                        </svg>
                      </div>
                      ...
                      {/* <p className="text-gray-500 text-sm">
                        Coba ubah filter cabang, kata kunci, atau rentang tanggal.
                      </p> */}
                    </div>
                  </td>
                </tr>
