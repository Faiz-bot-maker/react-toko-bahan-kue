...
const AdminTransaksiMasuk = () => {
    ...
    }, [ endDate, branchFilter, statusFilter, currentPage, searchTerm ] );
                        ...
                        <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto p-6">
                            ...
                            <div className="mt-4 grid grid-cols-2 gap-4 text-sm text-gray-700">
                                ...
                                <p><strong>Status:</strong>
                                    <span className={ `ml-1 font-semibold ${selectedTransaction.status === "COMPLETED"
                                        ? "text-green-600"
                                        ...
                                        <tbody>
                                            { selectedTransaction.items?.map( ( item, idx ) => (
                                                <tr key={ idx } className="hover:bg-gray-50">
                                                    ...
                                                    <td className={ `px-3 py-2 border font-semibold ${item.is_cancelled ? "text-red-500" : "text-green-600"
                                                        }` }>
