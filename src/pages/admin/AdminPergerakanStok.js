...
const AdminPergerakanStok = () => {
    ...
    const fetchMovements = async ( targetPage = page ) => {
        try {
            ...
            if ( res.data?.paging ) setTotalPage( res.data.paging.total_page );
        } catch ( err ) {
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden">
                                ...
                                { loading ? (
                                    ...
                                    movements.map( ( mv, index ) => (
                                        <tr key={ mv.id } className="hover:bg-gray-50">
                                            <td className="px-6 py-4 font-medium text-gray-900">{ ( page - 1 ) * size + index + 1 }</td>
                                            ...
                                            <td className={ `px-6 py-4 font-semibold ${mv.change_qty > 0 ? "text-green-600" : "text-red-600"}` }>
                    ...
                    <div className="flex items-center justify-end gap-2 px-6 py-3 border-t border-gray-100">
                        ...
                        <button
                            ...
                            className={ `px-3 py-1.5 rounded border ${page === totalPage || totalPage === 0 ? "text-gray-400 border-gray-200" : "text-gray-700 border-gray-300 hover:bg-gray-50"}` }
                        >
                            Next
                        </button>
                        <button
                            ...
                            disabled={ page === totalPage || totalPage === 0 }
                            className={ `px-2.5 py-1.5 rounded border ${page === totalPage || totalPage === 0 ? "text-gray-400 border-gray-200" : "text-gray-700 border-gray-300 hover:bg-gray-50"}` }
                        >
                            »
                        </button>
                    </div>
