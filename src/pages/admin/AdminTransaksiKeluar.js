...
import { HiOutlineShoppingCart, HiOutlineDocumentReport } from "react-icons/hi";
...
const AdminTransaksiKeluar = () => {
    ...
    }, [page, appliedDateRange, search, statusFilter]);
                                ...
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan={5} className="px-6 py-16 text-center text-gray-500">
                                            <div className="flex flex-col items-center gap-3">
                                                ...
                                                <span className="text-lg font-semibold">Tidak ditemukan penjualan</span>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
                                    sales.map((sale) => (
                                        <tr key={sale.code} className="hover:bg-gray-50">
                                            ...
                                            <td className={`px-6 py-3 font-medium ${sale.status.toUpperCase() === "COMPLETED" ? "text-green-600" : sale.status.toUpperCase() === "PENDING" ? "text-yellow-600" : "text-red-600"}`}>
                                                {sale.status}
                                            </td>
