...
const AdminModal = () => {
    ...
    const [form, setForm] = useState({
        ...
        note: "",
        amount: "",
        branch_id: null, // nanti diisi sesuai cabang admin
    });
    ...
    const openAdd = () => {
        setForm({ id: null, type: "OUT", note: "", amount: "", branch_id: Number(branchId) });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // pastikan branch_id admin
            const payload = { ...form, branch_id: Number(branchId) };
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">
                                Kelola pemasukan dan pengeluaran modal cabang Anda
                            </p>
                        </div>
                    </div>
                    <button
